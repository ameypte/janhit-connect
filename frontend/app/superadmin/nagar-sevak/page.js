                ...
                <div className="container mx-auto w-3/4 mb-3 flex">
                    ...
                    <div className="grow">
                        <div className="flex flex-row-reverse">
                            <Link href="/superadmin/add-nagar-sevak" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Add Nagar Sevak</Link>
                        </div>
                    </div>
                </div>
